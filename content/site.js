...
module.exports = {
  ...
  links: [
    // TODO: swap this href for the public `.notion.site` URL once the Posts
    // Directory page is published to web (Notion → Share → Publish). The
    // app.notion.com link below only works while signed in as the page owner.
    { label: 'Writing', href: 'https://app.notion.com/p/Posts-Directory-3c6e8016a7fa80ed9cc0f8dcc42df75d?source=0x43eba_website', external: true },
